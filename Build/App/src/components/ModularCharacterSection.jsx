...
const ModularCharacterSection = () => {
    ...
    const featuredImages = [
        assetPath("/assets/ModularCharacterShowcase/Featured1.png"),
        assetPath("/assets/ModularCharacterShowcase/Featured2.png"),
        assetPath("/assets/ModularCharacterShowcase/Featured3.png"),
        assetPath("/assets/ModularCharacterShowcase/Featured4.png")
    ];
        ...
        <div className="w-full flex flex-col items-center justify-center mb-20 text-left px-4 md:px-0">
            ...
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-5 space-y-4">
                    ...
                    >
                        <ReactPlayer
                            url={assetPath("/assets/ModularCharacterShowcase/Showcase_Scripts.mp4")}
                            width="100%"
                            height="100%"
                            playing={true}
                            muted={true}
