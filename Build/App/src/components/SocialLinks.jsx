...
const socialLinks = [
  {
    ...
    subText: "Ardirdn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ardirdn/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "ardigamedev",
    icon: BsDiscord,
    url: "https://discordapp.com/users/656810059694866473/",
    color: "#504aff",
  ...
  },
  {
    ...
    subText: "@ardigamedev",
    icon: Instagram,
    url: "https://www.instagram.com/ardigamedev",
    color: "#E4405F",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@ardigamedev",
    color: "black",
    ...
    <div data-aos="fade-left" data-aos-duration="1200" className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <a data-aos="fade-right" data-aos-duration="1200" data-aos-delay="600"
          href={"mailto:Ardirdeveloper@gmail.com"}
          target="_blank"
          rel="noopener noreferrer"
          className="group relative flex items-center justify-between p-4 rounded-lg 
                    bg-white/5 border border-white/10 overflow-hidden
