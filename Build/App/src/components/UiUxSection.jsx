...
const UiUxSection = () => {
    ...
    // Note: targetImages are used for matching against uiuxData (which also uses raw paths)
    // assetPath is applied when rendering
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-10 mb-16">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                    ...
                    <div className="md:col-span-3 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-right" data-aos-delay="100">
                        <img src={assetPath(displayItems[0].src)} alt={displayItems[0].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="md:col-span-6 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-down" data-aos-delay="200">
                        <img src={assetPath(displayItems[1].src)} alt={displayItems[1].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="md:col-span-3 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-left" data-aos-delay="300">
                        <img src={assetPath(displayItems[2].src)} alt={displayItems[2].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="md:col-span-4 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-up-right" data-aos-delay="400">
                        <img src={assetPath(displayItems[3].src)} alt={displayItems[3].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="md:col-span-2 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-up" data-aos-delay="500">
                        <img src={assetPath(displayItems[4].src)} alt={displayItems[4].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="md:col-span-2 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-up" data-aos-delay="600">
                        <img src={assetPath(displayItems[5].src)} alt={displayItems[5].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="md:col-span-4 h-[200px] md:h-[250px] relative rounded-xl overflow-hidden group border border-white/10 bg-slate-900" data-aos="fade-up-left" data-aos-delay="700">
                        <img src={assetPath(displayItems[6].src)} alt={displayItems[6].title} className="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-110" />
