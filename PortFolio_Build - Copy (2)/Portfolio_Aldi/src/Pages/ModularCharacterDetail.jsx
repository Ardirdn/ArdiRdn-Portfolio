...
const ModularCharacterDetail = () => {
    ...
    const topVideos = [
        "/assets/ModularCharacterShowcase/ModularCharacter_Boy.mp4",
        "/assets/ModularCharacterShowcase/ModularCharacter_Fat.mp4",
        "/assets/ModularCharacterShowcase/ModularCharacter_Female.mp4",
        "/assets/ModularCharacterShowcase/ModularCharacter_Girl.mp4",
        "/assets/ModularCharacterShowcase/ModularCharacter_Male.mp4",
        "/assets/ModularCharacterShowcase/ModularCharacter_Muscular.mp4"
    ];
    ...
    const contentSections = [
        {
            ...
            media: "/assets/ModularCharacterShowcase/Showcase_Scripts.mp4",
            type: "video",
            reversed: false
        },
        {
            ...
            media: "/assets/ModularCharacterShowcase/Showcase_Blender.mp4",
            type: "video",
            reversed: true
        },
        {
            ...
            media: "/assets/ModularCharacterShowcase/MaterialShowcase.mp4",
            type: "video",
            reversed: false
        },
        {
            ...
            media: "/assets/ModularCharacterShowcase/Day.png",
            type: "image",
            reversed: true
        }
    ];
