...
# Reuse loading logic... for brevity I'll trust the previous logic was correct in gathering used_assets.
# I will just copy the block again to be sure.
...
for asset in used_assets:
    ...
    elif not asset.startswith("/assets/"):
        ignored.append(asset)
        
print(f"Total used: {len(used_assets)}")
